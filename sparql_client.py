...
class EndpointClient:
    ...
    # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
        ...
        self.prefixes = dict()
        self.prefixes[":"] = "http://sibils.org/rdf#"
        self.prefixes["sibilc:"] = "http://sibils.org/rdf/concept/"
    ...
    # - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
        elems = list()
        elems.append("PREFIX : <http://sibils.org/rdf#>")
        elems.append("PREFIX sibilc: <http://sibils.org/rdf/concept/>")
