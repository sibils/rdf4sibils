...
for elems in dt_list:
        if elems.text in ["Authors:", "Contributors:", "Publisher:"]:
            if elems.text == "Contributors:":
                append_dd_link(elems, "https://orcid.org/0000-0002-3374-2962", "Patrick Ruch (SIB)")
                append_dd_link(elems, "https://orcid.org/0000-0003-2209-5218", "Alexandre Flament (HES-SO Genève)")
